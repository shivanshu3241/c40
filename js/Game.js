  ...
  play(){
    ...
    if(allPlayers !== undefined){
      ...
      for(var plr in allPlayers){
        ...
        image(hurdle1, x, -1000, 200, 200);
        image(hurdle1, x, -1500, 200, 200);
        image(hurdle1, x, -2000, 200, 200);
        image(hurdle1, x, -2500, 200, 200);
        image(hurdle1, x, -3000, 200, 200);
        image(hurdle1, x, -3500, 200, 200);
